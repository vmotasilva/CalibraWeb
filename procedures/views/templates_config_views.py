...
TAGS_REFERENCIA = {
    'LISTA_PRESENCA': [
        ...
        # Tags de Bloco Único (Recomendadas - 1 tag por célula):
        {'tag': '{{CATEGORIA_TREINAMENTO}}', 'descricao': '⭐ Linha Completa: ○ Treinamento ● Reunião ○ Reciclagem'},
        {'tag': '{{METODOLOGIA}}', 'descricao': '⭐ Linha Completa: ○ LOFT ● Tradicional'},
        {'tag': '{{AREA_CONHECIMENTO}}', 'descricao': '⭐ Linha Completa: ○ Adm ○ Qualidade ○ EHS ○ Estoque ● Produção ○ Outros'},
        {'tag': '{{NECESSITA_AVALIACAO}}', 'descricao': '⭐ Linha Completa: ○ Sim ● Não'},
        # Tags de Linha de Participantes:
        ...
        # Tags Individuais por Opção (Opcional):
        {'tag': '{{CHK_TREIN}}', 'descricao': 'Marcação (●/○) individual para Treinamento'},
        {'tag': '{{CHK_REUN}}', 'descricao': 'Marcação (●/○) individual para Reunião'},
        {'tag': '{{CHK_RECIC}}', 'descricao': 'Marcação (●/○) individual para Reciclagem'},
        {'tag': '{{CHK_LOFT}}', 'descricao': 'Marcação (●/○) individual para Metodologia LOFT'},
        {'tag': '{{CHK_TRAD}}', 'descricao': 'Marcação (●/○) individual para Metodologia Tradicional'},
        {'tag': '{{CHK_AVAL_SIM}}', 'descricao': 'Marcação (●/○) individual para Necessita Avaliação: SIM'},
        {'tag': '{{CHK_AVAL_NAO}}', 'descricao': 'Marcação (●/○) individual para Necessita Avaliação: NÃO'},
        {'tag': '{{CHK_ADM}}', 'descricao': 'Marcação (●/○) individual para Administrativo'},
        {'tag': '{{CHK_QUALIDADE}}', 'descricao': 'Marcação (●/○) individual para Qualidade'},
        {'tag': '{{CHK_EHS}}', 'descricao': 'Marcação (●/○) individual para EHS'},
        {'tag': '{{CHK_ESTOQUE}}', 'descricao': 'Marcação (●/○) individual para Estoque'},
        {'tag': '{{CHK_PRODUCAO}}', 'descricao': 'Marcação (●/○) individual para Produção'},
        {'tag': '{{CHK_OUTROS}}', 'descricao': 'Marcação (●/○) individual para Outros'},
    ],
    'AUTO_AVALIACAO': [
        {'tag': '{{COLABORADOR}}', 'descricao': 'Nome do Colaborador Avaliado'},
        {'tag': '{{MATRICULA}}', 'descricao': 'Matrícula do Colaborador Avaliado'},
        {'tag': '{{CARGO}}', 'descricao': 'Cargo / Função do Colaborador Avaliado'},
        {'tag': '{{SETOR}}', 'descricao': 'Setor / Departamento do Colaborador Avaliado'},
        {'tag': '{{GESTOR}}', 'descricao': 'Gestor / Líder Direto do Colaborador Avaliado'},
        {'tag': '{{LIDER}}', 'descricao': 'Líder / Superior Imediato do Colaborador'},
        {'tag': '{{PROCEDIMENTO}}', 'descricao': 'Código e Nome do Procedimento Crítico'},
        {'tag': '{{INSTRUTOR}}', 'descricao': 'Nome do Facilitador / Instrutor'},
        {'tag': '{{DATA}}', 'descricao': 'Data da Sessão do Treinamento'},
        {'tag': '{{PER_1}}', 'descricao': 'Enunciado da Pergunta 1 (Vértice 1 do Gráfico Radar)'},
        {'tag': '{{PER_2}}', 'descricao': 'Enunciado da Pergunta 2 (Vértice 2 do Gráfico Radar)'},
        {'tag': '{{PER_3}}', 'descricao': 'Enunciado da Pergunta 3 (Vértice 3 do Gráfico Radar)'},
        {'tag': '{{PER_4}}', 'descricao': 'Enunciado da Pergunta 4 (Vértice 4 do Gráfico Radar)'},
        {'tag': '{{PER_5}}', 'descricao': 'Enunciado da Pergunta 5 (Vértice 5 do Gráfico Radar)'},
    ],
    'AVALIACAO_EFICACIA': [
        {'tag': '{{COLABORADOR}}', 'descricao': 'Nome do Colaborador Avaliado'},
        {'tag': '{{MATRICULA}}', 'descricao': 'Matrícula do Colaborador Avaliado'},
        {'tag': '{{CARGO}}', 'descricao': 'Cargo do Colaborador Avaliado'},
        {'tag': '{{SETOR}}', 'descricao': 'Setor / Departamento do Colaborador Avaliado'},
        {'tag': '{{GESTOR}}', 'descricao': 'Gestor / Superior Direto do Colaborador Avaliado'},
        {'tag': '{{AVALIADOR}}', 'descricao': 'Nome do Avaliador / Responsável pela Eficácia'},
        {'tag': '{{PROCEDIMENTO}}', 'descricao': 'Procedimento Crítico Vinculado'},
        {'tag': '{{DATA_TREINAMENTO}}', 'descricao': 'Data da Realização do Treinamento'},
        {'tag': '{{DATA_EFICACIA_CALCULADA}}', 'descricao': 'Data Prevista de Eficácia (+30 Dias de Carência)'},
        {'tag': '{{DATA_AVALIACAO}}', 'descricao': 'Data Efetiva da Avaliação de Eficácia'},
        {'tag': '{{STATUS_EFICACIA}}', 'descricao': 'Resultado da Eficácia (Eficaz / Ineficaz / Não se Aplica)'},
        {'tag': '{{OBSERVACOES}}', 'descricao': 'Parecer técnico / Evidências / Justificativa'},
    ],
    'PLANEJAMENTO_MATRIZ': [
        {'tag': '{{ANO}}', 'descricao': 'Ano de Referência do Cronograma Anual'},
        {'tag': '{{TOTAL_TREINAMENTOS}}', 'descricao': 'Total de Treinamentos Contidos no Cronograma'},
        {'tag': '{{SETOR}}', 'descricao': 'Setor do Treinamento'},
        {'tag': '{{GESTOR}}', 'descricao': 'Gestor Responsável'},
        {'tag': '{{DATA_EMISSAO}}', 'descricao': 'Data de Emissão do Relatório'},
    ],
    'CERTIFICADO': [
