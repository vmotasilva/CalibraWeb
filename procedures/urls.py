...
urlpatterns = [
    ...
    path('treinamentos/avaliacao-eficacia/alterar-gestor-massa/', views.avaliacao_eficacia_alterar_gestor_massa_view, name='avaliacao_eficacia_alterar_gestor_massa'),
    ...
    path('treinamentos/avaliacao-eficacia/api/search-options/', views.avaliacao_eficacia_search_options_api, name='avaliacao_eficacia_search_options_api'),
    ...
    path('perfis/<int:perfil_id>/integracao/<int:pacote_id>/editar/', perfis_views.salvar_pacote_integracao_view, name='editar_pacote_integracao'),
    path('perfis/<int:perfil_id>/integracao/<int:pacote_id>/deletar/', perfis_views.deletar_pacote_integracao_view, name='deletar_pacote_integracao'),
    path('perfis/<int:perfil_id>/integracao/copiar-grupo/', perfis_views.copiar_grupo_para_pacote_view, name='copiar_grupo_para_pacote'),
    path('perfis/<int:perfil_id>/integracao/<int:pacote_id>/copiar-perfil/', perfis_views.copiar_pacote_entre_perfis_view, name='copiar_pacote_entre_perfis'),
