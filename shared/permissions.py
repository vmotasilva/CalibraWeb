        ...
        "blocos": [
            ...
            },
            {
                ...
                "funcoes": [
                    ...
                    {"nome": "Registrar Avaliação de Eficácia em Massa", "view_name": "procedures:avaliacao_eficacia_registrar_massa", "perm": "core.nav_treinamentos_registros"},
        ...
        "blocos": [
            ...
            },
            {
                ...
                "funcoes": [
                    ...
                    {"nome": "Execução da Entrevista", "view_name": "auditoria:iso_entrevista_view", "perm": "core.nav_auditoria_iso_entrevista"},
            ...
            },
            {
                ...
                "funcoes": [
                    ...
                    {"nome": "Normas ISO (Gestão e Templates)", "view_name": ["auditoria:iso_norma_create", "auditoria:iso_norma_detail", "auditoria:iso_norma_edit", "auditoria:iso_norma_archive", "auditoria:iso_norma_delete", "auditoria:iso_norma_upload_template", "auditoria:iso_norma_delete_template", "auditoria:iso_norma_download_template", "auditoria:iso_norma_download_template_padrao", "auditoria:iso_norma_regras_salvar"], "perm": "core.nav_auditoria_iso_normas"},
                    {"nome": "Itens da Norma", "view_name": ["auditoria:iso_item_create", "auditoria:iso_item_edit", "auditoria:iso_item_delete", "auditoria:iso_item_detail_api", "auditoria:iso_item_toggle_atalho_api"], "perm": "core.nav_auditoria_iso_itens"},
                    {"nome": "Banco de Perguntas ISO", "view_name": ["auditoria:iso_pergunta_create", "auditoria:iso_pergunta_edit", "auditoria:iso_pergunta_delete"], "perm": "core.nav_auditoria_iso_perguntas"},
                    {"nome": "Modelos e Blocos ISO", "view_name": ["auditoria:iso_modelo_create", "auditoria:iso_modelo_detail", "auditoria:iso_modelo_edit", "auditoria:iso_modelo_archive", "auditoria:iso_modelo_delete", "auditoria:iso_modelo_bloco_create", "auditoria:iso_modelo_bloco_edit", "auditoria:iso_modelo_bloco_delete", "auditoria:iso_modelo_bloco_perguntas", "auditoria:iso_modelo_bloco_pergunta_create", "auditoria:iso_modelo_bloco_sincronizar", "auditoria:iso_modelo_bloco_alvo_update"], "perm": "core.nav_auditoria_iso_modelos"},
                    {"nome": "Planejamento e Agendas ISO", "view_name": ["auditoria:iso_auditoria_create", "auditoria:iso_auditoria_detail", "auditoria:iso_auditoria_edit", "auditoria:iso_auditoria_archive", "auditoria:iso_auditoria_delete", "auditoria:iso_auditoria_import_modelo", "auditoria:iso_agenda_create", "auditoria:iso_agenda_detail", "auditoria:iso_agenda_edit", "auditoria:iso_agenda_archive", "auditoria:iso_agenda_delete", "auditoria:iso_agenda_perguntas_edit", "auditoria:iso_agenda_pergunta_create", "auditoria:iso_agenda_alvo_update", "auditoria:iso_agenda_sincronizar_modelo"], "perm": "core.nav_auditoria_iso_agendas"},
                ],
            },
        ],
    },
        ...
        "blocos": [
            ...
            },
            {
                ...
                "funcoes": [
                    ...
                    {"nome": "Dashboard", "view_name": "laboratorio:dashboard_coating", "perm": "core.nav_laboratorio_coating_dashboard"},
                    {"nome": "Importação", "view_name": ("laboratorio:importar_lotes_coating", "laboratorio:baixar_modelo_importacao_coating"), "perm": "core.nav_laboratorio_coating_importacao"},
