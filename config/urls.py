...
urlpatterns = [
    ...
    path('dl-template-inst/', views.dl_template_instr, name='dl_template_instr'),
    path('dl-template-colab/', views.dl_template_colab, name='dl_template_colab'),
    path('dl-template-hier/', views.dl_template_hierarquia, name='dl_template_hierarquia'),
