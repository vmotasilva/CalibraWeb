...
urlpatterns = [
    ...
    path("iso/<int:auditoria_id>/exportar-docx/", views.iso_auditoria_export_docx, name="iso_auditoria_export_docx"),
    ...
    path("iso/setup/itens/<int:pk>/toggle-atalho/", views.iso_item_toggle_atalho_api, name="iso_item_toggle_atalho_api"),
