...
urlpatterns = [
    ...
    path("perguntas/<int:pk>/mover-cima/", views.pergunta_move_up, name="pergunta_move_up"),
    path("perguntas/<int:pk>/mover-baixo/", views.pergunta_move_down, name="pergunta_move_down"),
    ...
    path(
        "registros/selecionar-modelo/",
        views.selecionar_modelo_preenchimento,
        name="selecionar_modelo_preenchimento",
    ),
