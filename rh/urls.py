...
urlpatterns = [
    ...
    path('api/ferias/<int:ferias_id>/', api_ferias_detail, name='api_ferias_detail'),
    path('api/ferias/configuracao/', api_configuracao_ferias, name='api_configuracao_ferias'),
